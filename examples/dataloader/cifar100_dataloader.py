...
def get_cifar100(
    ...
    if comm_rank == 0:
        test_data_raw = torchvision.datasets.CIFAR100(dir, download=True, train=False, transform=test_transform("CIFAR100"))
    if comm is not None:
        comm.Barrier()
    if comm_rank > 0:
        test_data_raw = torchvision.datasets.CIFAR100(dir, download=False, train=False, transform=test_transform("CIFAR100"))
    ...
    train_data_raw = torchvision.datasets.CIFAR100(dir, download=False, train=True, transform=train_transform("CIFAR100"))
    ...
    if visualization:
        ...
        output_filename = f"CIFAR100_{num_clients}clients_{partition}_distribution"
        file_ext = ".pdf"
